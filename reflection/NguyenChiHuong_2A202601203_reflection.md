...
- Trực tiếp phỏng vấn và ghi lại 10 chuỗi 5-why qua hai đợt trong `Phỏng vấn.txt` và `Phỏng vấn thêm nữa.txt`.
...
- Nối thêm 5 người mới dưới mã `KS-05–KS-09` vào `evidence/survey-log.md`, giữ nguyên người cũ và không trùng mã người dùng validation; sau chống đếm trùng, mẫu có 17 người duy nhất và 13 người ngoài nhóm.
...
**Deliverable cụ thể:**
- Log thô: `C:\Users\Dell\OneDrive\Desktop\Phỏng vấn.txt` và `C:\Users\Dell\OneDrive\Desktop\Phỏng vấn thêm nữa.txt`.
- Artifact mình chịu trách nhiệm: `spec.md` §1–§2 và log khảo sát nối tiếp tại `evidence/survey-log.md`.
- Kết quả evidence cập nhật: 11/13 người ngoài nhóm xác nhận friction; còn thiếu 7 người ngoài nhóm để đạt chuẩn A. Cụm B “không moi được pain từ người khác” có reach cao nhất, 8/15 người có pain.
...
- Quyết định thiết kế quan trọng nhất mình đưa ra: không chỉ đếm số người nói “có khó khăn”, mà phải chống đếm trùng, dựa vào lời nguyên văn và giữ lại negative case. Sau đợt 2, cụm “không moi được pain từ người khác” có reach cao nhất (8/15), củng cố lựa chọn **Đào Gốc** là vấn đề thượng nguồn có thể build trong thời gian hackathon.
...
| Việc | Ai làm | Ghi chú |
|---|---|---|
| Phỏng vấn và ghi câu trả lời của 10 lượt qua hai đợt | Mình | Mình trực tiếp hỏi, nghe và ghi lại nội dung; AI không thể thay thế nguồn bằng chứng người thật. |
...
**Điểm mình còn phải hoàn thiện sau đợt phỏng vấn mới:**
> File đợt 2 chưa ghi vai, câu hỏi từng lượt, hậu quả và đồng thuận sử dụng dữ liệu. Mình cần hỏi lại các trường này và thu thêm 7 người ngoài nhóm; mình không dùng AI để tự điền vào phần còn thiếu.
