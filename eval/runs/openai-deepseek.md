# Kết quả golden set — `OpenAI deepseek-v4-flash` — lượt `deepseek`
...
| 11 | `n1-assumption` | lop-1 | – | ✓ | – | ✗ | ask | Con số phỏng đoán PHẢI gán ASSUMPTION, không được coi là bằng chứng. |
| 12 | `n1-market` | lop-1 | – | ✓ | ✓ | ✗ | ask | Không có tool search → không được phát biểu về thị trường. Kiểm bằng c |
| 13 | `n1-no-basis` | lop-1 | – | ✓ | ✓ | ✓ | ask | Rác. Agent hỏi lại hoặc dừng với chain_incomplete — KHÔNG được bịa một |
...
|---|---|---|:---:|
| 1 · nhãn tầng đúng | 85.7% (12/14) | ≥70% | ✓ |
| 2 · không mớm đáp án | 100.0% (23/23) | **100% (cứng)** | ✓ |
| 3 · điều kiện dừng đúng | 95.5% (21/22) | theo dõi | – |
| 4 · không sinh số thiếu nguồn | 78.3% (18/23) | **100% (cứng)** | ✗ |
