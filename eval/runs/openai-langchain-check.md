# Kết quả golden set — `OpenAI gpt-4o-mini` — lượt `langchain-check`
...
| 14 | `n2-vague` | lop-2 | ✓ | ✓ | ✗ | ✓ | stop | Đề bài gọi thẳng câu này là 'không đạt'. Phải hỏi lại, không tự điền. |
| 15 | `n2-short` | lop-2 | ✓ | ✓ | ✗ | ✓ | stop | 3 từ, không có chủ thể. Hỏi ai mất và ở bước nào. |
...
| 3 · điều kiện dừng đúng | 50.0% (11/22) | theo dõi | – |
